...
public class Question5B {
    public int BatteryReplacements(int[][] serviceCenters, int targetMiles, int startChargeCapacity) {
        int count = 0;
    ...
    public static void main(String[] args) {
        ...
        int finalAnswer=question1.BatteryReplacements(serviceCenterList,100,10);
